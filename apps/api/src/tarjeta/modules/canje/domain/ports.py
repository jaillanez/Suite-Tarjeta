...
class TransaccionRepository(Protocol):
    ...
    # §10.6: agregado por persona para el panel del titular (montos y puntos, sin detalle de
    # compras). Devuelve (operaciones, monto_bruto, descuento, puntos_acreditados, puntos_usados).
